...
namespace station
{
    public partial class frmStytrain : Form
    {
        ...
        {
            totalStaion = 0;
            string SourceStation = lstStart.Text; //"Langara–49th Avenue";//Metrotown//YVR//YVR
            string DestinationStation = lstEnd.Text;// "Burquitlam";//Holdom//Holdom//King George
