    ...
    public partial class frmStytrain : Form
    {
        ...
        public void PrintStations(string[] a, string startStation, string endStation)
        {
           // Console.WriteLine("/////////////////////////////////////////////////");
            ...
            HashSet<string> lstFulfillfinal = new HashSet<string>();

            foreach (string n in lstRoute.Items)
            {

                if (lstFulfillfinal.Text =null)
                {
                    lstFulfillfinal.Add(n);
                }
                else
                {
                    lstFulfillfinal.Add(n);
            ...
            foreach (string x in lstFulfillfinal)
            {
                lstRoute.Items.Add(x);
            }
